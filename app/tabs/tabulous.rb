...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #----------------------------------------------------------------------------------------------------#
      [    :customers_tab    ,    'Customers'     ,    customers_path    ,    true        ,    true        ],
      [    :addresses_tab    ,    'Addresses'     ,    addresses_path    ,    true        ,    true        ],
  ...
  config.actions do
    [
      ...
      #--------------------------------------------------------------#
      [    :customers    ,    :all_actions    ,    :customers_tab    ],
      [    :addresses    ,    :all_actions    ,    :addresses_tab    ],
